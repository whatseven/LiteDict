...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolButton.setGeometry(QtCore.QRect(510, 130, 31, 31))
        self.toolButton.setObjectName("toolButton")
        self.toolButton_2 = QtWidgets.QToolButton(self.centralwidget)
        self.toolButton_2.setGeometry(QtCore.QRect(510, 30, 31, 31))
        self.toolButton_2.setObjectName("toolButton_2")
        self.toolButton_3 = QtWidgets.QToolButton(self.centralwidget)
        self.toolButton_3.setGeometry(QtCore.QRect(510, 80, 31, 31))
        ...
        self.toolButton.clicked.connect(MainWindow.downloadButtonPushed)
        self.toolButton_2.clicked.connect(MainWindow.removeButtonPushed)
        self.toolButton_3.clicked.connect(MainWindow.uploadButtonPushed)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolButton.setText(_translate("MainWindow", "Dw"))
        self.toolButton_2.setText(_translate("MainWindow", "-"))
        self.toolButton_3.setText(_translate("MainWindow", "UP"))
